...
public class miniMax extends Board2 {
    static Scanner sk = new Scanner(System.in);
    static Board2 bf = new Board2();
    ...
    public static int minimax(Board2 bd, int depth, boolean max) {
    ...
    public static int[][] getPossibleMoves(Board2 bd) { //gets all possible moves
    ...
    public static boolean updateBoard2(int x, int y) { //updates the board
        if (legalMove(x, y)) {
            board[x][y] = "  X  ";
            return true;
        }
